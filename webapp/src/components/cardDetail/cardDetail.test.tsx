...
describe('components/cardDetail/CardDetail', () => {
    ...
    // NOTE: 'should show add properties tour tip' test removed as part of IT-521
    // Property editing was moved from card dialog to board settings,
    // so the AddPropertiesTourStep is no longer shown in card detail.
