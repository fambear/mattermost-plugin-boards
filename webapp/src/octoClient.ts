...
class OctoClient {
    ...
    async getGitHubConnected(): Promise<{connected: boolean}> {
        ...
        return this.getJson(response, {connected: false})
    }

    async getGitHubRepositories(channelId?: string): Promise<any[]> {
        const queryParams = channelId ? `?channelId=${encodeURIComponent(channelId)}` : ''
        const path = `/api/v2/github/repositories${queryParams}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
    ...
    async searchGitHubIssues(term: string): Promise<any[]> {
        const path = `/api/v2/github/issues/search?term=${encodeURIComponent(term)}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
    ...
    async createGitHubIssue(request: any): Promise<any> {
    ...
    async getGitHubIssue(owner: string, repo: string, number: number): Promise<any> {
        const path = `/api/v2/github/issues/${encodeURIComponent(owner)}/${encodeURIComponent(repo)}/${number}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
    ...
    async getGitHubLabels(repo: string): Promise<any[]> {
        const path = `/api/v2/github/labels?repo=${encodeURIComponent(repo)}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
    ...
    async getGitHubMilestones(repo: string): Promise<any[]> {
        const path = `/api/v2/github/milestones?repo=${encodeURIComponent(repo)}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
    ...
    async getGitHubAssignees(repo: string): Promise<any[]> {
        const path = `/api/v2/github/assignees?repo=${encodeURIComponent(repo)}`
        const response = await fetch(this.getBaseURL() + path, Client4.getOptions({
            method: 'GET',
            headers: this.headers(),
        }))
