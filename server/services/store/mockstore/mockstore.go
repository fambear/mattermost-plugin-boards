...
// RepairCardBlockOrder mocks base method.
func (m *MockStore) RepairCardBlockOrder(arg0, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RepairCardBlockOrder", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// RepairCardBlockOrder indicates an expected call of RepairCardBlockOrder.
func (mr *MockStoreMockRecorder) RepairCardBlockOrder(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RepairCardBlockOrder", reflect.TypeOf((*MockStore)(nil).RepairCardBlockOrder), arg0, arg1)
}
